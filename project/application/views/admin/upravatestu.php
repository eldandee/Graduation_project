...
<div class="row">
      ...
      <div class="col-xs-5">
      	...
      	<h1>Úprava  <?php echo $test["nazev"];?></h1>
</div>
...
<div class="row">
      ...
      <div class="col-xs-5">
      	...
      	echo      	form_open_multipart('upravaTestuDone');?>
		<div class="form-group">
							<label for="nazev" class="cols-sm-2 control-label">Název testu:</label>
							
							
									<input type="text" class="form-control" value='<?php echo $test["nazev"]; ?>'name="nazev" id="nazev" required/>
      ...
      <h3>Otázky z kategorie: <?php   foreach($kat as $row)
        echo $row->NazevKa;
 ?> </h3>
...
<div class="row">
    ...
    <div class="col-xs-5">
        ...
        <?php     foreach($OtazkyNVT as $key =>$val)
 ...
 ?> 
        ...
        echo '<h4>Upravuje: '.$user->first_name.' <b style="color:red">'.$user->username.'</b> '.$user->last_name.'</h4>';
 ?> 
        <div class="form-group ">
            
            <input type="hidden" id="pocet" name="pocet" value="0">
          				<button type="submit" id="necum" class="btn btn-primary btn-lg btn-block login-button" onclick="selectAll();" >Odeslat</button></form>
