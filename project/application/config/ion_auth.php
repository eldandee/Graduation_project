...
$config['default_group']              = 'uzivatel';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['ucitel_group']               = 'ucitel';            // Defaultní skupina ucitele
...
$config['email']                      = 'email';             //uživatel se muže zaregistrovat jen na jeden email
