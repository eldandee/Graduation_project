...
class Ion_auth
{
	...
	public function __get($var)
	{
       ...
       public function zadosti($id) {
        $tridy = $this->MainModel->mojetridy($id);
        $pocet = 0;
        foreach ($tridy as $val) {
            $pocet += $this->MainModel->pocetZadosti($val->idTrida)->pocet;
        }
	...
	public function is_admin($id=false)
	{
		...
		return $this->in_group($admin_group, $id);
     	...
     	public function is_ucitel($id=false)
	{

		$ucitel_group = $this->config->item('ucitel_group', 'ion_auth');
         
		return $this->in_group($ucitel_group);
	}
	/**
	 * in_group
	 *
